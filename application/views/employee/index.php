                    ...
                    <?php foreach ($employee as $e) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url('employee/edit/') . $e['e_id_number']; ?>" class="badge badge-success">Edit</a>
                                <a href="<?= base_url('employee/deleteEmployee/') . $e['e_id_number']; ?>" class="badge badge-danger delete">Delete</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
